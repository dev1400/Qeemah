...
jQuery.sap.require("sap.ui.demo.tdg.helper.ModelHelper");
...
sap.ui.demo.tdg.util.Controller.extend("sap.ui.demo.tdg.view.Detail", {
	...
	onInit : function() {
        ...
        this.ModelHelper = sap.ui.demo.tdg.helper.ModelHelper;

		this.getRouter().getRoute("orderDetails").attachMatched(this.onRouteMatched, this);
